...
Group.new("Number", colors.glacier, nil, nil)
...
Group.new("Special", colors.bouquete, nil, styles.bold) --null, tsx compoenets values
...
Group.new("TSNumber", colors.glacier, nil, nil)
...
Group.new("@variable.lua", colors.mystic, nil, nil)
Group.new("@variable.member.lua", colors.gray_suit, nil, nil)
Group.new("@variable.tsx", colors.mystic, nil, nil)
Group.new("@variable.typescript", colors.mystic, nil, nil)
Group.new("@variable.builtin", colors.mystic, nil, nil)
