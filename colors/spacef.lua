...
Group.new("MatchParen", colors.nord4, colors.charade, nil)
...
--P
Group.new("Pmenu", colors.nord4, colors.charade, nil)
...
Group.new("Tag", colors.bouquete, nil, nil)
...
Group.new("nord4space", colors.blue_bouquete, nil, nil)
Group.new("WildMenu", colors.nord4, nil, nil)
Group.new("lCursor", colors.nord4, nil, nil)

--Plugins
--buffer
Group.new("BufferCurrent", colors.nord4, colors.bouquete, nil)
...
Group.new("BufferLineFill", colors.nord4, colors.bouquete, styles.bold)
...
Group.new("@import.identifier.tsx", colors.shadow_green:dark(), nil, nil)
