...
local group_defs = {
	...
	IncSearch = { colors.antique_brass, nil, nil },
	...
	MarkviewHeading1 = { colors.shadow_green, colors.gunmetal, nil },
	MarkviewHeading2 = { colors.bouquete, colors.gunmetal, nil },
	MarkviewHeading3 = { colors.glacier, colors.gunmetal, nil },
	MarkviewHeading4 = { colors.horizon, colors.gunmetal, nil },
	MarkviewHeading5 = { colors.mandy, colors.gunmetal, nil },
	MarkviewHeading6 = { colors.antique_brass, colors.gunmetal, nil },
	...
	WinSeparator = { colors.bouquete, colors.bouquete, nil },
