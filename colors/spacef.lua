...
local group_defs = {
	...
	DiffChange = { colors.nord14, nil, nil },
	DiffDelete = { colors.contessa, nil, nil },
	...
	TermCursor = { colors.mystic, colors.powder_blue, nil },
	...
	BufferInactiveSign = { colors.bouquete, colors.dark_blue, nil },
	BufferInactiveTarget = { colors.mandy, colors.dark_blue, styles.bold },
