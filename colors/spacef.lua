...
local group_defs = {
	...
	MarkviewHeading1 = { colors.shadow_green, colors.river_bed, nil },
	MarkviewHeading2 = { colors.bouquete, colors.river_bed, nil },
	MarkviewHeading3 = { colors.glacier, colors.river_bed, nil },
	MarkviewHeading4 = { colors.horizon, colors.river_bed, nil },
	MarkviewHeading5 = { colors.mandy, colors.river_bed, nil },
	MarkviewHeading6 = { colors.antique_brass, colors.river_bed, nil },
