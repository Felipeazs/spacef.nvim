...
Group.new("@markup.heding.1.tsx", colors.nord7, nil, nil)
Group.new("@markup.heding.2.tsx", colors.nord7, nil, nil)
Group.new("@markup.heding.3.tsx", colors.nord7, nil, nil)
Group.new("@markup.heding.4.tsx", colors.nord7, nil, nil)
Group.new("@markup.heding.5.tsx", colors.nord7, nil, nil)
Group.new("@markup.heding.6.tsx", colors.nord7, nil, nil)
