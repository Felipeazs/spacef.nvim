...
Group.new("VisualSpecial", colors.slate_nord3, colors.black, nil)
...
Group.new("CmpItemKindField", colors.nord4, nil, nil)
Group.new("CmpItemKindFunction", colors.nord15, nil, nil)
Group.new("CmpItemKindInterface", colors.nord8, nil, nil)
Group.new("CmpItemKindMethod", colors.nord15, nil, nil)
Group.new("CmpItemKindKeyword", colors.nord7, nil, nil)
Group.new("CmpItemKindOperator", colors.nord11, nil, nil)
...
Group.new("CmpItemKindVariable", colors.nord8, nil, nil)
Group.new("CmpItemMenu", colors.nord15, nil, nil)
...
Group.new("@markup.heading.1.tsx", colors.nord7, nil, nil)
Group.new("@markup.heading.2.tsx", colors.nord7, nil, nil)
Group.new("@markup.heading.3.tsx", colors.nord7, nil, nil)
Group.new("@markup.heading.4.tsx", colors.nord7, nil, nil)
Group.new("@markup.heading.5.tsx", colors.nord7, nil, nil)
Group.new("@markup.heading.6.tsx", colors.nord7, nil, nil)
